...
export const products: Product[] = [
  {
    ...
    seoTitle: 'Classic Cedar Patio Planter | Coastline Cedar Co.',
    seoDescription:
      'Compact hand-built cedar patio planter from Coastline Cedar Co. Locally crafted in Greater Vancouver. From $149. Delivery available.'
  },
  {
    ...
    seoTitle: 'Long Cedar Balcony Planter | Greater Vancouver | Coastline Cedar Co.',
    seoDescription:
      'Slim cedar balcony planter built for Vancouver condos and apartments. Hand-built in BC. From $199. Custom sizes available.'
  },
  {
    ...
    seoTitle: 'Large Outdoor Cedar Planter Box | Coastline Cedar Co.',
    seoDescription:
      'Large hand-built cedar planter box for Vancouver homes and patios. Architectural quality. From $249. Local delivery.'
  },
  {
    ...
    seoTitle: 'Raised Cedar Garden Planter | Vancouver | Coastline Cedar Co.',
    seoDescription:
      'Waist-height raised cedar garden planter for vegetables and herbs. Built locally in Greater Vancouver. From $299.'
  },
  {
    ...
    seoTitle: 'Privacy Cedar Planter with Trellis | Coastline Cedar Co.',
    seoDescription:
      'Cedar privacy planter with built-in trellis. Block sightlines and grow climbers on your Vancouver patio. From $549.'
  },
  {
  ...
  },
  {
    ...
    description:
      'Have a tricky corner, a stairwell, or a precise design in mind? We build to your measurements. Send us length, width, and height — plus a photo of the space if you have one — and we’ll come back with a quote, sketch, and timeline. Most custom planters ship within 2–3 weeks.',
    ...
    features: [
      ...
      'Most custom orders ready in 2–3 weeks'
    ],
    ...
    seoTitle: 'Custom Cedar Planter Boxes Vancouver | Coastline Cedar Co.',
    seoDescription:
