...
export default function Footer() {
  return (
    <footer className="mt-24 border-t border-charcoal-900/10 bg-bone">
      <div className="mx-auto grid max-w-8xl gap-10 px-5 py-16 md:grid-cols-2 lg:grid-cols-5 lg:px-10">
        <div className="lg:col-span-1">
          ...
          <p className="mt-3 max-w-xs text-sm text-charcoal-900/70">
            Hand-built cedar planters, privacy panels, saunas, gates, and fences for homes and
            businesses across Greater Vancouver. Made locally on the North Shore.
          </p>
        ...
        <div>
          ...
          <ul className="mt-4 space-y-2 text-sm">
            <li><Link href="/shop" className="text-charcoal-900/80 hover:text-cedar-700">Cedar Planters</Link></li>
            <li><Link href="/custom-planters" className="text-charcoal-900/80 hover:text-cedar-700">Custom Planters</Link></li>
            <li><Link href="/cedar-privacy-panels-vancouver" className="text-charcoal-900/80 hover:text-cedar-700">Privacy Panels</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="mt-4 space-y-2 text-sm">
            <li><Link href="/custom-outdoor-saunas-vancouver" className="text-charcoal-900/80 hover:text-cedar-700">Custom Outdoor Saunas</Link></li>
            <li><Link href="/handmade-cedar-gates-fences-vancouver" className="text-charcoal-900/80 hover:text-cedar-700">Gates &amp; Fences</Link></li>
            <li><Link href="/custom-planters" className="text-charcoal-900/80 hover:text-cedar-700">Custom Builds</Link></li>
      ...
      <div className="border-t border-charcoal-900/10">
        <div className="mx-auto max-w-8xl px-5 py-6 text-xs text-charcoal-900/60 lg:px-10">
          <p>
            Locally built cedar planters, privacy panels, saunas, gates, and fences in North Vancouver,
            West Vancouver, Vancouver, Burnaby, Richmond, Coquitlam, Port Moody, Port Coquitlam, New Westminster, Surrey,
            Delta, and Langley.
          </p>
